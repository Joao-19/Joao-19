...
const I18N = {
  pt: {
    ...
    "projects.pro1.name": "HouseDo — Plataforma Imobiliária",
    "projects.pro1.meta": "Japão · 2021 – 2025",
    ...
    "about.t1.text": "Técnico em Automação Industrial na ETERJ, programando microcontroladores em C/C++ com Arduino. Cada projeto e desafio concluído no curso só aumentava o interesse — e essa experiência inicial amadureceu até virar a base do pontapé inicial como programador.",
    "about.t1.cap1": "Feira de ciências: garra controlada via Bluetooth por um exo-braço remoto — acesso remoto de uma garra.",
    "about.t1.cap2": "Visita técnica ao Grupo Santa Luzia (Itaguaí), no estágio do técnico.",
    "about.t2.year": "2021",
    ...
    "about.t3.text": "Os primeiros trabalhos como desenvolvedor, em 2021: full stack em projeto para Cootraporter via ByteRain (sistema logístico para 120+ veículos e ~500 entregas diárias) e para Egnex/Nexomobi via ByteRain, recuperando e evoluindo sistemas legados em produção — além de diversos outros pedidos pelo caminho.",
    "about.t5.year": "2021 – 2022",
    "about.t5.title": "Imersão nos estudos",
    "about.t5.text": "Nesse período encarei uma batelada de cursos na Alura, patrocinados pela ByteRain — um empurrão pelo qual sou grato até hoje. Com o tempo, o formato mudou: hoje prefiro documentação técnica, conteúdo gratuito e aprender na prática, criando e testando meus próprios projetos em vez de partir direto para cursos.",
    "about.t5.pill2": "certificados na Alura ↗",
    "about.t4.year": "2022 – 2025",
    "about.t4.title": "Escala internacional",
    "about.t4.text": "De 2022 em diante vieram os projetos internacionais: atuei no setor imobiliário no Japão, na HouseDo — prestando serviço pela ByteRain, onde evoluí de Júnior a Pleno e, depois, Sênior. Participei de quase todo o ciclo do produto, com foco nos apps iOS de uma plataforma com 15 mil+ imóveis.",
    "about.t4.pill1": "intermediado pela ByteRain",
    "about.t4.pill2": "HouseDo · Japão",
    "about.t4.pill3": "Júnior → Pleno → Sênior",
    "about.t4.more": "Apps iOS em que atuei ao longo do ciclo:",
    "about.t4.app1": "MyPage — web & app",
    "about.t4.app2": "HouseDo — app",
    "about.t4.app3": "DoSupport — web & app",
    "about.t4.app4": "+ outros apps · modernização UIKit → SwiftUI",
    "about.t3.pill1": "Cootraporter · logística",
    "about.t3.pill2": "Egnex / Nexomobi",
    "about.t6.year": "2026",
    "about.t6.title": "Guia de Compras CasaShopping",
    "about.t6.text": "Projeto desenvolvido sob demanda, intermediado pela Brick: plataforma de catálogo de produtos com painel administrativo, em arquitetura de microsserviços — monorepo Turborepo com Next.js, NestJS, PostgreSQL, MinIO e Docker. Atuei do código à infraestrutura, cuidando também do deploy.",
    "about.t6.pill1": "intermediado pela Brick",
    "about.t6.pill2": "FullStack + DevOps",
    "about.t7.year": "2026",
    "about.t7.title": "WePlanner",
    "about.t7.text": "Projeto próprio: uma plataforma de gestão e planejamento colaborativo, com dashboard, automações e múltiplos serviços num monorepo Turborepo (NestJS + Next.js), usando Prisma e PostgreSQL. É onde experimento produto de ponta a ponta — da modelagem do banco à experiência de uso.",
    "about.t7.pill1": "projeto próprio",
    "about.t7.pill2": "Turborepo · NestJS · Next.js",
    "about.t8.year": "2026",
    "about.t8.title": "Worlds RPG",
    "about.t8.text": "Também autoral: plataforma de RPG multiplayer com aplicação web, painel administrativo e API em arquitetura de microsserviços (Next.js, NestJS, TypeScript e PostgreSQL). Junta o interesse por jogos que começou lá atrás com engenharia de verdade — e fecha o ciclo desta trajetória.",
    "about.t8.pill1": "projeto próprio",
    "about.t8.pill2": "microsserviços · TypeScript",
    "about.t8.pill3": "ver projetos",
    "about.expand": "ver apps & detalhes",
  ...
  en: {
    ...
    "projects.pro1.name": "HouseDo — Real Estate Platform",
    "projects.pro1.meta": "Japan · 2021 – 2025",
    ...
    "about.intro": "I'm João Vitor, a full stack developer born in Rio de Janeiro, with 5+ years of experience across front-end, back-end, mobile and DevOps. The curiosity goes back much further: since I was a kid I wanted to know how games, websites and apps were built on the inside.",
    "about.timeline.title": "My journey",
    "about.t1.year": "2016 – 2020",
    "about.t1.title": "Where it all began",
    "about.t1.text": "Technical course in Industrial Automation at ETERJ, programming microcontrollers in C/C++ with Arduino. Every project and challenge completed during the course only grew my interest — and that early experience matured into the foundation for my first steps as a programmer.",
    "about.t1.cap1": "Science fair: a claw controlled via Bluetooth by a remote exo-arm, demonstrating remote access to a claw.",
    "about.t1.cap2": "Technical visit to Grupo Santa Luzia, in Itaguaí, during the technical course internship.",
    "about.t2.year": "2021",
    ...
    "about.t3.text": "My first jobs as a developer, in 2021: full stack on a project for Cootraporter via ByteRain (a logistics system for 120+ vehicles and ~500 daily deliveries) and for Egnex/Nexomobi via ByteRain, recovering and evolving legacy systems in production — plus several other requests along the way.",
    "about.t5.year": "2021 – 2022",
    "about.t5.title": "Deep-dive into studying",
    "about.t5.text": "During this period I took on a marathon of Alura courses, sponsored by ByteRain — a push I'm grateful for to this day. Over time the format changed: nowadays I prefer technical documentation, free content and learning by doing, building and testing my own projects instead of going straight for courses.",
    "about.t5.pill2": "Alura certificates ↗",
    "about.t4.year": "2022 – 2025",
    "about.t4.title": "International scale",
    "about.t4.text": "From 2022 onward came the international projects: I worked in real estate in Japan, at HouseDo — providing services through ByteRain, where I grew from Junior to Mid-level and then Senior. I took part in almost the entire product cycle, focused on the iOS apps of a platform with 15,000+ properties.",
    "about.t4.pill1": "brokered by ByteRain",
    "about.t4.pill2": "HouseDo · Japan",
    "about.t4.pill3": "Junior → Mid-level → Senior",
    "about.t4.more": "iOS apps I worked on across the cycle:",
    "about.t4.app1": "MyPage — web & app",
    "about.t4.app2": "HouseDo — app",
    "about.t4.app3": "DoSupport — web & app",
    "about.t4.app4": "+ other apps · UIKit → SwiftUI modernization",
    "about.t3.pill1": "Cootraporter · logistics",
    "about.t3.pill2": "Egnex / Nexomobi",
    "about.t6.year": "2026",
    "about.t6.title": "CasaShopping Shopping Guide",
    "about.t6.text": "A project built on demand, brokered by Brick: a product catalog platform with an admin panel, in a microservices architecture — Turborepo monorepo with Next.js, NestJS, PostgreSQL, MinIO and Docker. I worked from code to infrastructure, including the deploy.",
    "about.t6.pill1": "brokered by Brick",
    "about.t6.pill2": "FullStack + DevOps",
    "about.t7.year": "2026",
    "about.t7.title": "WePlanner",
    "about.t7.text": "A project of my own: a collaborative management and planning platform, with a dashboard, automations and multiple services in a Turborepo monorepo (NestJS + Next.js), using Prisma and PostgreSQL. It's where I experiment with product end to end — from database modeling to user experience.",
    "about.t7.pill1": "own project",
    "about.t7.pill2": "Turborepo · NestJS · Next.js",
    "about.t8.year": "2026",
    "about.t8.title": "Worlds RPG",
    "about.t8.text": "Also my own: a multiplayer RPG platform with a web app, admin panel and API in a microservices architecture (Next.js, NestJS, TypeScript and PostgreSQL). It brings together the love for games that started way back with real engineering — and closes the loop on this journey.",
    "about.t8.pill1": "own project",
    "about.t8.pill2": "microservices · TypeScript",
    "about.t8.pill3": "view projects",
    "about.expand": "view apps & details",
