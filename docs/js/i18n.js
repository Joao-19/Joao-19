...
const I18N = {
  pt: {
    ...
    "about.t4.text": "De 2022 em diante vieram os projetos internacionais: atuei no setor imobiliário no Japão, na HouseDo — contratado pela ByteRain, onde evoluí de Júnior a Pleno e, depois, Sênior. Participei de quase todo o ciclo do produto, com foco nos apps iOS de uma plataforma com 15 mil+ imóveis.",
    ...
    "about.t6.year": "2026",
    "about.t6.title": "Produtos próprios",
    "about.t6.text": "O momento de tirar ideias próprias do papel: o Guia de Compras CasaShopping, plataforma de catálogo com painel administrativo, e os projetos WePlanner e Worlds RPG — todos detalhados na página de projetos.",
    "about.t6.pill1": "Guia de Compras CasaShopping",
    "about.t6.pill2": "WePlanner",
    "about.t6.pill3": "Worlds RPG",
    "about.t6.pill4": "ver projetos",
  ...
  en: {
    ...
    "about.t4.text": "From 2022 onward came the international projects: I worked in real estate in Japan, at HouseDo — hired by ByteRain, where I grew from Junior to Mid-level and then Senior. I took part in almost the entire product cycle, focused on the iOS apps of a platform with 15,000+ properties.",
    ...
    "about.t3.pill2": "Egnex / Nexomobi",
    "about.t6.year": "2026",
    "about.t6.title": "My own products",
    "about.t6.text": "Time to bring my own ideas to life: the CasaShopping Shopping Guide, a catalog platform with an admin panel, and the WePlanner and Worlds RPG projects — all detailed on the projects page.",
    "about.t6.pill1": "CasaShopping Shopping Guide",
    "about.t6.pill2": "WePlanner",
    "about.t6.pill3": "Worlds RPG",
    "about.t6.pill4": "view projects",
